...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Funcionario.carga_mensal'
        db.add_column(u'erp_funcionario', 'carga_mensal',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Funcionario.carga_mensal'
        db.delete_column(u'erp_funcionario', 'carga_mensal')
