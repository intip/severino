...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Projeto.descricao'
        db.add_column(u'erp_projeto', 'descricao',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Projeto.descricao'
        db.delete_column(u'erp_projeto', 'descricao')
    ...
    models = {
        ...
        u'erp.projeto': {
            ...
            'estimativa_horas': ('django.db.models.fields.FloatField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nome': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
