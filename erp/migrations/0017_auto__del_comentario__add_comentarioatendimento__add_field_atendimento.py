...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'erp_comentario')

        # Adding model 'ComentarioAtendimento'
        db.create_table(u'erp_comentarioatendimento', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('atendimento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['erp.Atendimento'])),
            ('texto', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'erp', ['ComentarioAtendimento'])

        # Adding field 'Atendimento.titulo'
        db.add_column(u'erp_atendimento', 'titulo',
                      self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 9, 30, 0, 0), max_length=60),
                      keep_default=False)

        # Adding field 'Atendimento.created'
        db.add_column(u'erp_atendimento', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 30, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Atendimento.modified'
        db.add_column(u'erp_atendimento', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 9, 30, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'Comentario'
        db.create_table(u'erp_comentario', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'erp', ['Comentario'])

        # Deleting model 'ComentarioAtendimento'
        db.delete_table(u'erp_comentarioatendimento')

        # Deleting field 'Atendimento.titulo'
        db.delete_column(u'erp_atendimento', 'titulo')

        # Deleting field 'Atendimento.created'
        db.delete_column(u'erp_atendimento', 'created')

        # Deleting field 'Atendimento.modified'
        db.delete_column(u'erp_atendimento', 'modified')
