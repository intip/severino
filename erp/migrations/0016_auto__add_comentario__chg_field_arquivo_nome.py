...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Arquivo.nome'
        db.alter_column(u'erp_arquivo', 'nome', self.gf('django.db.models.fields.CharField')(max_length=90))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Arquivo.nome'
        db.alter_column(u'erp_arquivo', 'nome', self.gf('django.db.models.fields.CharField')(max_length=30))
